...
include_once $this->targetDirs[3].'/src/Repository/BlogPostRepository.php';

return $this->services['App\Repository\BlogPostRepository'] = new \App\Repository\BlogPostRepository(${($_ = isset($this->services['doctrine']) ? $this->services['doctrine'] : $this->getDoctrineService()) && false ?: '_'});
