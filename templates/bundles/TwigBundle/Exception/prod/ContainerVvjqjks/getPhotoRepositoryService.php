...
// Returns the private 'App\Repository\PhotoRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/PhotoRepository.php';

return $this->services['App\Repository\PhotoRepository'] = new \App\Repository\PhotoRepository(${($_ = isset($this->services['doctrine']) ? $this->services['doctrine'] : $this->getDoctrineService()) && false ?: '_'});
