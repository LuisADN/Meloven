...
include_once $this->targetDirs[3].'/src/Repository/EventRepository.php';

return $this->services['App\Repository\EventRepository'] = new \App\Repository\EventRepository(${($_ = isset($this->services['doctrine']) ? $this->services['doctrine'] : $this->getDoctrineService()) && false ?: '_'});
